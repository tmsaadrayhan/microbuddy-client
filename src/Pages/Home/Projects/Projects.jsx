            ...
            >
              <div>
                <div className="flex items-center">
                  <article className="mx-[0rem] max-w-[40rem] m-4 p-[2rem]">
                    <header>
              ...
              <div>
                <div className="flex items-center">
                  <article className="mx-[2rem] md:mx-[0rem] md:max-w-[40rem] m-4 p-[2rem]">
                    <header>
              ...
              <div className="pt-[5rem] text-black">
                <div className="pt-[1rem] blue-box lg:w-[120rem] rounded-3xl">
                  <img
                    ...
                    alt=""
                  />
                  <article className="text-center mx-auto m-4 p-[2rem]">
                    <header>
                      <h1 className="text-5xl font-bold">{appData[1].name}</h1>
                      <p className="text-[#666AE5] text-xl mb-[1rem]">
                        {appData[1].heading}
            ...
            <Slider autoplay={true} arrows={false}>
              <div className="lg:px-[20rem] lg:pb-[3rem] pt-[2rem] md:pt-[5rem] lg:pt-[10rem] text-black">
                <div className=" pt-[1rem] blue-box md:flex lg:w-[120rem] rounded-3xl">
                  <img
                    ...
                    alt=""
                  />
                  <article className="mx-[2rem] md:mx-[0rem] md:w-[30rem] m-4 p-[2rem]">
                    <header>
              ...
              <div className="pt-[2rem] md:pt-[5rem] lg:pt-[10rem] text-black">
                <div className="pt-[1rem] blue-box md:flex lg:w-[120rem] rounded-3xl">
                  <img
                    ...
                    alt=""
                  />
                  <article className="mx-[rem] md:mx-[0rem] md:w-[30rem] m-4 p-[2rem]">
                    <header>
              ...
              <div className="lg:px-[20rem] lg:pb-[3rem] pt-[2rem] md:pt-[5rem] lg:pt-[10rem] text-black">
                <div className=" pt-[1rem] blue-box md:flex lg:w-[120rem] rounded-3xl">
                  ...
                  <article className="mx-[rem] md:mx-[0rem] md:w-[30rem] m-4 p-[2rem]">
                    <header>
                      <h1 className="text-3xl font-bold">{appData[2].name}</h1>
                      <p className="text-[#666AE5] text-xl mb-[1rem]">
                        {appData[2].heading}
                      </p>
                    </header>
              ...
              <div className="lg:px-[20rem] lg:pb-[3rem] pt-[2rem] md:pt-[5rem] lg:pt-[10rem] text-black">
                <div className="pt-[1rem] blue-box md:flex lg:w-[105rem] rounded-3xl">
                  ...
                  <article className="mx-[rem] md:mx-[0rem] md:w-[30rem] m-4 p-[2rem]">
                    <header>
                      <h1 className="text-3xl font-bold">{appData[3].name}</h1>
                      <p className="text-[#666AE5] text-xl mb-[1rem]">
                        {appData[3].heading}
                      </p>
                    </header>
