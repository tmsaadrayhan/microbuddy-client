  ...
  return (
    <div className="lg:mx-auto">
      <div className="lg:max-w-[90rem] lg:mx-auto relative">
        ...
        <div>
          {/*lg*/}
          <div className="hidden absolute lg:block right-[116rem] w-[12rem] md:rounded-2xl">
            ...
            <div>
              <div className="flex items-center">
                ...
                <div className="text-end md:text-center lg:text-start lg:mx-[0] md:w-[30rem] m-4 p-[2rem]">
                  ...
                  <p>
                    Learn to code faster and more effectively with Speedy Buddy.
                    Our concise tutorials cover web development, data science,
                    machine learning, and more. Subscribe to our channel and
                    join our passionate community today.
                  </p>
                </div>
              </div>
            </div>
            <div>
              <div className="flex items-center ">
                ...
                <div className="text-end md:text-center lg:text-start md:mx-auto lg:mx-[0] md:w-[30rem] m-4 p-[2rem]">
                  ...
                  <p>
                    Design Buddy is here to improve your design skills with our
                    fast-paced tutorial videos from Microbuddyy’s best
          ...
          <div className="absolute right-[15rem] bottom-[5rem]">
          ...
          {/*md and sm*/}
          <div className="lg:hidden lg:ms-[-38rem] lg:max-w-[130rem] ms-[-2rem] md:ms-[-2rem] md:rounded-2xl mx:mx-auto">
